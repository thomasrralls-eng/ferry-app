...
function Toolbar({ recording, onStart, onStop, onExport, onClear, onSettings, hasAgent }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-wrap", children: [
    !recording ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-red-300" }),
          "Record"
        ]
      }
      ...
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-sm bg-white/80" }),
          "Stop"
        ]
      }
    ),
    ...
    recording && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 px-2 py-1 rounded-full bg-red-50 border border-red-200 text-[11px] font-semibold text-red-600", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-red-500 animate-pulse-dot" }),
      "REC"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `relative p-1.5 rounded-md border transition-colors ${hasAgent ? "border-amber-200 bg-amber-50 text-amber-600 hover:bg-amber-100" : "border-slate-200 bg-white text-slate-400 hover:bg-slate-50 hover:text-slate-600"}`,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { className: "w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: [
          ...
          hasAgent && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute -top-0.5 -right-0.5 w-2 h-2 rounded-full bg-amber-500 border-2 border-white" })
        ]
      }
    )
  ] });
...
function ScoreCard({ label, value, subtitle, variant = "events" }) {
  const v = VARIANTS[variant] || VARIANTS.events;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex-1 bg-white rounded-lg border border-gray-200 border-l-4 ${v.border} p-3 shadow-sm`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-2xl font-bold leading-tight ${v.text}`, children: value }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] font-semibold text-gray-400 mt-0.5", children: subtitle }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] font-medium text-gray-400 uppercase tracking-wide mt-0.5", children: label })
  ] });
}
function Tabs({ tabs, activeTab, onTabChange, counts }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-slate-200 mb-3", children: tabs.map((tab) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `
              ...
              ${isActive ? "text-amber-600 border-amber-500" : "text-slate-400 border-transparent hover:text-slate-600"}
            `,
        children: [
          tab.label,
          count !== void 0 && count > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `ml-1.5 px-1.5 py-0.5 rounded-full text-[10px] font-semibold ${isActive ? "bg-amber-100 text-amber-600" : "bg-slate-100 text-slate-400"}`, children: count })
        ]
      },
      tab.id
    );
...
function GroupedFindingCard({ ruleId, findings }) {
  ...
  for (const f of findings) {
    ...
    if (f.eventIndex !== void 0) entityCounts[name].eventIndices.push(f.eventIndex);
  }
  const entities = Object.entries(entityCounts).sort((a, b) => b[1].count - a[1].count);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `${s.bg} rounded-lg border-l-[3px] ${s.border} mb-2 shadow-sm overflow-hidden`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-1.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 rounded text-[10px] font-semibold uppercase ${s.badge}`, children: representative.severity }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-medium bg-gray-100 text-gray-500", children: CATEGORY_LABELS[representative.category] || representative.category }),
            count > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-gray-200 text-gray-600", children: [
              "×",
              count
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[13px] font-semibold text-gray-900 leading-snug", children: [
            representative.message,
            count > 1 && entityNames.length > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400 font-normal text-[12px]", children: [
              " ",
              "and ",
              entityNames.length - 1,
              " other",
              entityNames.length - 1 !== 1 ? "s" : ""
            ] })
          ] }),
          representative.detail && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-gray-500 leading-relaxed mt-1", children: representative.detail })
        ]
      }
    ),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-3 border-t border-gray-200/50", children: [
      entities.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 space-y-1", children: entities.map(([name, data]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 py-1 px-2 rounded bg-white/60", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-mono text-gray-700 flex-1 min-w-0 truncate", children: name }),
        data.count > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-semibold text-gray-400 flex-shrink-0", children: [
          "×",
          data.count
        ] }),
        data.eventIndices.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-gray-400 flex-shrink-0", children: [
          "event",
          data.eventIndices.length > 1 ? "s" : "",
          " #",
          data.eventIndices.map((i) => i + 1).slice(0, 5).join(", "),
          data.eventIndices.length > 5 ? "..." : ""
        ] })
      ] }, name)) }),
      representative.docs && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          ...
          children: [
            "View documentation",
            /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3 h-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) })
          ]
        }
      )
    ] })
...
function GroupedEventRow({ eventName, events, allFindings }) {
  const [expanded, setExpanded] = reactExports.useState(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white rounded-lg border border-gray-200 mb-1.5 shadow-sm overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: () => setExpanded(!expanded),
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold text-gray-900 truncate", children: eventName }),
            count > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-gray-200 text-gray-600 flex-shrink-0", children: [
              "×",
              count
            ] }),
            source && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-gray-400 flex-shrink-0", children: source })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
            totalErrors > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-red-100 text-red-700", children: [
              totalErrors,
              " error",
              totalErrors > 1 ? "s" : ""
            ] }),
            totalWarnings > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-amber-100 text-amber-700", children: [
              totalWarnings,
              " warn",
              totalWarnings > 1 ? "s" : ""
            ] }),
    ...
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-gray-100", children: events.map((entry, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-b border-gray-50 last:border-b-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: (e) => {
              e.stopPropagation();
              setExpandedChild(isChildOpen ? null : i);
            },
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                childErrors > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-red-400", title: `${childErrors} error(s)` }),
                childWarnings > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-2 h-2 rounded-full bg-amber-400", title: `${childWarnings} warning(s)` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
        ...
        isChildOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-gray-50 rounded-md p-2.5 text-[11px] text-gray-700 font-mono overflow-x-auto max-h-48 overflow-y-auto", children: JSON.stringify(evt, null, 2) }) })
      ] }, i);
    }) })
  ] });
}
function EventRow({ event, index, findings }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[13px] font-semibold text-gray-900", children: name }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
            errCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-red-100 text-red-700", children: [
              errCount,
              " error",
              errCount > 1 ? "s" : ""
            ] }),
            warnCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "px-1.5 py-0.5 rounded text-[10px] font-semibold bg-amber-100 text-amber-700", children: [
              warnCount,
              " warn",
              warnCount > 1 ? "s" : ""
            ] }),
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "bg-gray-50 rounded-md p-2.5 text-[11px] text-gray-700 font-mono overflow-x-auto max-h-64 overflow-y-auto", children: JSON.stringify(event, null, 2) }) })
      ]
    }
  );
}
function EmptyState({ icon, title, subtitle }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 text-center", children: [
    icon && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-4xl mb-3", children: icon }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[14px] font-medium text-slate-500", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[12px] text-slate-400 mt-1 max-w-xs", children: subtitle })
  ] });
}
function CrawlPanel({
  crawling,
  ...
  const [maxPages, setMaxPages] = reactExports.useState(50);
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 bg-white p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h3", { className: "text-sm font-semibold text-gray-800", children: [
            "Scan Complete",
            crawlReport.stopped && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1.5 text-xs font-normal text-gray-400", children: "(stopped early)" })
          ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-800", children: pageCount }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400 uppercase tracking-wider mt-0.5", children: "Pages" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-gray-800", children: totalEvents }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400 uppercase tracking-wider mt-0.5", children: "Events" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-2xl font-bold ${pagesWithoutEvents > 0 ? "text-amber-500" : "text-green-500"}`, children: pagesWithoutEvents > 0 ? pagesWithoutEvents : "0" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400 uppercase tracking-wider mt-0.5", children: "No Events" })
          ] })
        ] })
      ] }),
      pageCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(PageList, { pages: crawlReport.pages }),
      errors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-red-100 bg-red-50 p-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-semibold text-red-600 mb-1", children: [
          "Errors (",
          errors.length,
          ")"
        ] }),
        errors.map((err, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-[11px] text-red-500 truncate", title: err.url, children: [
  ...
  if (crawling) {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-amber-200 bg-amber-50/50 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-amber-700", children: "Scanning..." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full bg-white/60 rounded-full h-1.5 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between text-xs text-amber-600", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            visited,
            " / ",
            max,
        ...
        progress?.currentUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-amber-400 mt-2 truncate", title: progress.currentUrl, children: progress.currentUrl })
      ] }),
      errors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-red-500", children: [
        errors.length,
        " error",
        errors.length !== 1 ? "s" : ""
      ] })
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 bg-white p-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-semibold text-gray-800 mb-1", children: "Site Scanner" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 mb-4 leading-relaxed", children: "Crawl pages from the site you're on, capturing all dataLayer events and GA4 hits on each page." }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-shrink-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-[11px] font-medium text-gray-500 mb-1", children: "Max pages" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "number",
...
function PageList({ pages }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-xs font-semibold text-gray-500 mb-1.5", children: [
      "Pages (",
      pages.length,
      ")"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-gray-200 bg-white divide-y divide-gray-100 overflow-hidden", children: pages.map((page, i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-700 truncate flex-1 mr-2", title: page.url, children: path }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5 flex-shrink-0", children: [
                eventCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] px-1.5 py-0.5 bg-amber-50 text-amber-600 rounded font-medium", children: [
                  eventCount,
                  " event",
                  eventCount !== 1 ? "s" : ""
                ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-1.5 py-0.5 bg-amber-50 text-amber-500 rounded font-medium", children: "no events" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "svg",
                  {
        ...
        isOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-2 bg-gray-50/50", children: eventCount > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5 pt-1", children: page.events.map((evt, j) => /* @__PURE__ */ jsxRuntimeExports.jsx(EventMini, { evt }, j)) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-400 py-1", children: "No dataLayer events detected on this page." }) })
      ] }, i);
    }) })
  ] });
}
function EventMini({ evt }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 py-0.5", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[9px] px-1 py-0.5 rounded font-medium ${sourceColors[source] || "bg-gray-100 text-gray-500"}`, children: source }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] text-gray-600 font-mono truncate", children: name })
  ] });
}
function AgentReportPanel({ report, agentAnalysis, onDismiss, onViewFindings }) {
  const [expandedAction, setExpandedAction] = reactExports.useState(null);
  const [collapsedBuckets, setCollapsedBuckets] = reactExports.useState({});
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 animate-in", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-xl border border-amber-100 bg-gradient-to-br from-white to-amber-50/30 p-4 shadow-sm", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-amber-900", children: analysisLabel }),
          ga4Version && ga4Version.version !== "free" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded-full ${ga4Version.version === "360" ? "bg-purple-100 text-purple-700 border border-purple-200" : "bg-amber-50 text-amber-700 border border-amber-200"}`, children: ga4Version.version === "360" ? "GA4 360" : "GA4 360?" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          onViewFindings && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(HealthRing, { score: health.score, label: health.label, scoreLabel }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: summary.totalEvents || 0, label: "Events", color: "indigo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: summary.eventsWithErrors || 0, label: "w/ Errors", color: "red" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: summary.warnings, label: "Warnings", color: "amber" })
          ] }),
          actionItems.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-gray-500 mt-2 leading-relaxed", children: [
            "We found ",
          ...
          actionItems.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-green-600 mt-2 font-medium", children: "No issues found — your tracking looks clean!" })
        ] })
      ] })
    ] }),
    insights.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-amber-100 bg-amber-50/30 p-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[11px] font-semibold text-amber-500 uppercase tracking-wider mb-2", children: "Session Overview" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: insights.map((insight, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(InsightIcon, { type: insight.type }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs font-medium text-gray-700", children: insight.title }),
          insight.detail && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[11px] text-gray-400 leading-relaxed mt-0.5 break-words", children: insight.detail })
        ] })
      ] }, i)) })
    ] }),
    crawlAnalysis && /* @__PURE__ */ jsxRuntimeExports.jsx(CrawlSummary, { crawlAnalysis }),
    agentAnalysis && /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectedInsights, { agentAnalysis }),
    activeBuckets.map((bucketKey) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-lg border ${meta.borderColor} overflow-hidden`, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-5 h-5 rounded-full ${meta.iconBg} flex items-center justify-center`, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px]", children: meta.icon }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-gray-800", children: bucket.label }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] text-gray-400 ml-1.5", children: [
                    bucket.actions.length,
                    " item",
                    bucket.actions.length !== 1 ? "s" : ""
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                hasProActions && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-semibold bg-amber-100 text-amber-600", children: "PRO" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronIcon, { rotated: !isCollapsed })
              ] })
            ]
          }
        ),
        !isCollapsed && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-1.5 bg-white/50 border-b border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-500 leading-relaxed", children: bucket.description }) }),
        !isCollapsed && isConversational && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 space-y-2 bg-white/30", children: bucket.actions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          ConversationalGroup,
          {
            action,
            isExpanded: expandedAction === action.ruleId,
            onToggle: () => setExpandedAction(expandedAction === action.ruleId ? null : action.ruleId)
          },
          action.ruleId
        )) }),
        !isCollapsed && !isConversational && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2 space-y-2 bg-white/30", children: bucket.actions.map((action) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    tierBreakdown?.pro > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border border-amber-200 bg-gradient-to-r from-amber-50 to-amber-50 p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-8 h-8 rounded-lg bg-gradient-to-br from-amber-400 to-amber-500 flex items-center justify-center flex-shrink-0 shadow-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-4 h-4 text-white", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M13 10V3L4 14h7v7l9-11h-7z" }) }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "text-sm font-semibold text-gray-800 mb-1", children: [
          tierBreakdown.pro,
          " fix",
          tierBreakdown.pro !== 1 ? "es" : "",
          " need GTM/GA4 access"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-500 leading-relaxed mb-2", children: "Medium- and high-risk changes require connecting your GTM container or GA4 property so data fairy can safely apply changes, preview them, and roll back if needed." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "px-3 py-1.5 text-xs font-semibold text-white bg-gradient-to-r from-amber-500 to-amber-500 rounded-lg hover:from-amber-600 hover:to-amber-600 shadow-sm transition", children: "Connect GTM/GA4 — Coming Soon" })
      ] })
    ] }) })
  ] });
}
...
function ExternalLinkIcon() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3 h-3", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" }) });
}
function HealthRing({ score, label, scoreLabel = "Implementation Score" }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-shrink-0", style: { width: size, height: size }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { width: size, height: size, className: "-rotate-90", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: center, cy: center, r: radius, fill: "none", stroke: "#f3f4f6", strokeWidth: stroke }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "circle",
        {
          cx: center,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 flex flex-col items-center justify-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-gray-800", style: { lineHeight: 1 }, children: score }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[8px] text-gray-400 font-medium uppercase mt-1 tracking-wide leading-tight text-center px-1", children: scoreLabel })
    ] })
  ] });
}
function StatPill({ value, label, color }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex-1 rounded-lg border px-2 py-1.5 ${colors[color]}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold leading-none", children: value }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[9px] font-medium uppercase mt-0.5 opacity-70", children: label })
  ] });
}
function InsightIcon({ type }) {
  const icons = {
    "measurement-ids": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-amber-100 text-amber-600 flex items-center justify-center font-bold", children: "G" }),
    "event-variety": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-amber-100 text-amber-600 flex items-center justify-center font-bold", children: "#" }),
    "ecommerce": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-amber-100 text-amber-600 flex items-center justify-center font-bold", children: "$" }),
    "error-ratio": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-red-100 text-red-600 flex items-center justify-center font-bold", children: "!" }),
    "clean": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-green-100 text-green-600 flex items-center justify-center font-bold", children: "✓" }),
    "no-data": /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-amber-50 text-amber-400 flex items-center justify-center font-bold", children: "?" })
  };
  return icons[type] || /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] w-4 h-4 rounded bg-gray-100 text-gray-500 flex items-center justify-center font-bold", children: "·" });
}
function SeverityDot({ severity }) {
  const colors = { error: "bg-red-400", warning: "bg-amber-400", info: "bg-amber-400" };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-1.5 h-1.5 rounded-full ${colors[severity] || "bg-gray-300"} flex-shrink-0 mt-1` });
}
function ConnectedInsights({ agentAnalysis }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-amber-200 bg-gradient-to-br from-amber-50/60 to-amber-50/40 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5 rounded-full bg-amber-500 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3 h-3 text-white", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2.5, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M13 10V3L4 14h7v7l9-11h-7z" }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold text-amber-900", children: "Connected Insights" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] px-1.5 py-0.5 rounded-full bg-amber-100 text-amber-600 font-medium", children: "Live" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronIcon, { rotated: expanded })
        ]
      }
    ),
    expanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-3 space-y-3", children: [
      aiAnalysis && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-lg bg-white/70 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-amber-500 uppercase tracking-wider mb-1.5", children: "AI Analysis" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-gray-600 leading-relaxed", children: aiAnalysis })
      ] }),
      ga4Snapshot && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-lg bg-white/70 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-amber-500 uppercase tracking-wider mb-2", children: "GA4 — Last 30 Days" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-center mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: fmtNum(ga4Snapshot.sessions), label: "Sessions", color: "indigo" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: fmtNum(ga4Snapshot.totalUsers), label: "Users", color: "blue" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(StatPill, { value: fmtNum(ga4Snapshot.conversions), label: "Conversions", color: "amber" })
        ] }),
        ga4Snapshot.topEvents?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 font-medium uppercase tracking-wide mb-1", children: "Top Events" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1", children: ga4Snapshot.topEvents.slice(0, 8).map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "span",
            {
              ...
              children: [
                e.eventName,
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-amber-400", children: fmtCompact(e.eventCount) })
              ]
            },
            e.eventName
          )) })
      ...
      gtmSnapshot && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-lg bg-white/70 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-[10px] font-semibold text-amber-500 uppercase tracking-wider mb-2", children: [
          "GTM Container",
          gtmSnapshot.containerId && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "ml-1.5 font-mono text-amber-400 normal-case", children: gtmSnapshot.containerId })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 text-center mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-gray-800", children: gtmSnapshot.tagCount ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Tags" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-gray-800", children: gtmSnapshot.triggerCount ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Triggers" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-gray-800", children: gtmSnapshot.variableCount ?? "—" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Variables" })
          ] }),
          gtmSnapshot.customHtmlTags > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-base font-bold text-amber-500", children: gtmSnapshot.customHtmlTags }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Custom HTML" })
          ] })
        ] }),
        gtmSnapshot.ga4ConfigTags?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 font-medium uppercase tracking-wide mb-1", children: "GA4 Config Tags" }),
          gtmSnapshot.ga4ConfigTags.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 text-[11px]", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500", children: "✓" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-gray-600", children: t.measurementId }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 truncate", children: t.name })
          ] }, t.measurementId))
        ] }),
        gtmSnapshot.publishedVersion?.versionId && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[10px] text-gray-400 mt-1.5", children: [
          "Published version: ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono text-gray-600", children: [
            "v",
      ...
      bqSnapshot?.events?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-lg bg-white/70 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-amber-500 uppercase tracking-wider mb-2", children: "BigQuery — Raw GA4 360 Events" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 mb-1.5", children: "Top events by volume over last 30 days" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1", children: bqSnapshot.events.slice(0, 8).map((e) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between text-[11px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-gray-600 truncate", children: e.eventName }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gray-400 flex-shrink-0 ml-2", children: fmtCompact(e.count) })
        ] }, e.eventName)) })
      ] }),
      masterPatterns?.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2.5 rounded-lg bg-white/70 border border-amber-100", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h5", { className: "text-[10px] font-semibold text-amber-500 uppercase tracking-wider mb-1.5 flex items-center gap-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Industry Patterns" }),
          masterBusinessType && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-mono font-normal text-amber-300 normal-case", children: [
            "— ",
            masterBusinessType
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-gray-400 mb-1.5 leading-relaxed", children: "Common issues found across similar sites by the fairy master." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: masterPatterns.map((p, i) => {
          const severityColor = {
            error: "text-red-600 bg-red-50 border-red-100",
            warning: "text-amber-600 bg-amber-50 border-amber-100",
            info: "text-amber-600 bg-amber-50 border-amber-100"
          }[p.severity] || "text-gray-600 bg-gray-50 border-gray-100";
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded border px-2 py-1.5 ${severityColor}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2 mb-0.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-semibold uppercase", children: p.severity }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-medium opacity-70", children: [
                Math.round(p.frequency * 100),
                "% of sites"
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] leading-snug", children: p.pattern })
          ] }, i);
        }) })
      ] })
    ] })
...
function CrawlSummary({ crawlAnalysis }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-amber-100 bg-amber-50/40 p-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-[11px] font-semibold text-amber-600 uppercase tracking-wider mb-2", children: "Site Scan Summary" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 text-center mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-gray-800", children: crawlAnalysis.totalPages }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Pages" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-lg font-bold text-gray-800", children: crawlAnalysis.totalEvents }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "Events" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `text-lg font-bold ${crawlAnalysis.pagesWithoutEvents > 0 ? "text-amber-500" : "text-green-500"}`, children: crawlAnalysis.pagesWithoutEvents }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400", children: "No Events" })
      ] })
    ] }),
    crawlAnalysis.pageIssues?.map((issue, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      CrawlIssueCard,
      {
        issue,
...
function CrawlIssueCard({ issue, isExpanded, onToggle }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 rounded bg-white/60 border border-amber-100 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: onToggle,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SeverityDot, { severity: issue.severity }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-medium text-gray-700 flex-1", children: issue.title }),
            pageCount > PREVIEW_LIMIT && /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronIcon, { rotated: isExpanded, className: "w-3.5 h-3.5" })
          ] }),
          issue.suggestion && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-500 leading-relaxed", children: issue.suggestion })
        ]
      }
    ),
    issue.pages && issue.pages.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-2 pb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-0.5", children: issue.pages.slice(0, isExpanded ? void 0 : PREVIEW_LIMIT).map((url, j) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[10px] text-gray-400 font-mono truncate", children: url.replace(/^https?:\/\/[^/]+/, "") }, j)) }),
      !isExpanded && pageCount > PREVIEW_LIMIT && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: onToggle,
...
function ConversationalGroup({ action, isExpanded, onToggle }) {
  const [showAllItems, setShowAllItems] = reactExports.useState(false);
  const [expandedItemName, setExpandedItemName] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-lg border border-gray-200 bg-white overflow-hidden shadow-sm", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onToggle,
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-2 h-2 rounded-full ${c.dot} flex-shrink-0 mt-[7px]` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] font-medium text-gray-800 leading-snug", children: action.conversationalTitle || action.title }),
            hasItems && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1.5 flex flex-wrap gap-1", children: [
              visibleItems.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                ItemTag,
                {
                  item,
              ...
              !showAllItems && hiddenCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  onClick: (e) => {
                    e.stopPropagation();
              ...
              showAllItems && hiddenCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  onClick: (e) => {
                    e.stopPropagation();
            ...
            expandedItemName && /* @__PURE__ */ jsxRuntimeExports.jsx(
              ItemDetailPopover,
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mt-1.5 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 rounded text-[9px] font-medium ${c.bg} ${c.accent}`, children: action.severity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-medium bg-gray-100 text-gray-400", children: effortLabels[action.effort] || action.effort }),
              action.tier === "pro" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-semibold bg-amber-100 text-amber-600", children: "PRO" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronIcon, { rotated: isExpanded, className: "flex-shrink-0 mt-1 text-gray-300" })
        ] })
      }
    ),
    isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-3 border-t border-gray-100 bg-gray-50/30", children: [
      action.rationale && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 p-2 rounded bg-amber-50/50 border border-amber-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-amber-700 leading-relaxed", children: action.rationale }) }),
      action.steps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-1.5", children: "How to fix" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-1", children: action.steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-[12px] text-gray-600 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 rounded-full bg-gray-200 text-gray-500 text-[9px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5", children: i + 1 }),
          step
        ] }, i)) })
      ] }),
      action.snippet && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-1", children: "Example" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-[11px] text-gray-700 bg-gray-100 rounded-md p-2.5 overflow-x-auto leading-relaxed font-mono whitespace-pre-wrap", children: action.snippet })
      ] }),
      action.docs && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
        {
          href: action.docs,
          target: "_blank",
...
function ItemTag({ item, isExpandedInline, onToggleDetail }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center rounded border border-gray-200 bg-gray-100 overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 text-[11px] font-mono text-gray-600", children: item.name }),
    item.count > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        ...
        className: `px-1 py-0.5 text-[10px] font-semibold border-l border-gray-200 transition
            ${isExpandedInline ? "bg-amber-100 text-amber-600" : "bg-gray-50 text-gray-400 hover:bg-amber-50 hover:text-amber-500"}`,
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[12px] font-semibold text-gray-700", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: item.name }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: onClose,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-gray-500 leading-relaxed", children: [
          "This event fired ",
          /* @__PURE__ */ jsxRuntimeExports.jsxs("strong", { className: "text-gray-700", children: [
            item.count,
            " time",
            item.count !== 1 ? "s" : ""
          ] }),
          " during this session, and each time the same issue was present:"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1.5 p-2 rounded bg-gray-50 border border-gray-100", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-gray-600 leading-relaxed", children: detail }) })
      ]
    }
  );
}
function ActionCard({ action, isExpanded, onToggle }) {
  ...
  const effortLabels = { quick: "Quick fix", medium: "Moderate effort", large: "Major project" };
  const c = severityColors[action.severity] || severityColors.info;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `rounded-lg border border-gray-200 border-l-[3px] ${c.border} bg-white overflow-hidden shadow-sm`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        onClick: onToggle,
        className: "w-full text-left px-3 py-2.5 hover:bg-gray-50/50 transition",
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `w-5 h-5 rounded-full ${c.num} text-white text-[10px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5`, children: action.priority }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-0.5 flex-wrap", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `px-1.5 py-0.5 rounded text-[9px] font-semibold uppercase ${c.badge}`, children: action.severity }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-medium bg-gray-100 text-gray-400", children: action.theme }),
              action.effort && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-medium bg-gray-50 text-gray-400 border border-gray-100", children: effortLabels[action.effort] || action.effort }),
              action.tier === "pro" && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-1.5 py-0.5 rounded text-[9px] font-semibold bg-amber-100 text-amber-600", children: "PRO" }),
              action.occurrences > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[9px] text-gray-400", children: [
                "×",
                action.occurrences
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-[13px] font-semibold text-gray-800 leading-snug", children: action.title })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronIcon, { rotated: isExpanded, className: "flex-shrink-0 mt-1 text-gray-300" })
        ] })
      }
    ...
    isExpanded && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-3 pb-3 border-t border-gray-100 bg-gray-50/30", children: [
      action.rationale && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 p-2 rounded bg-amber-50/50 border border-amber-100", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-amber-700 leading-relaxed", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Why this risk level:" }),
        " ",
        action.rationale
      ] }) }),
      action.description && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-gray-500 leading-relaxed mt-2", children: action.description }),
      action.steps.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h5", { className: "text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-1.5", children: "How to fix" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "space-y-1", children: action.steps.map((step, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-[12px] text-gray-600 leading-relaxed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-4 h-4 rounded-full bg-gray-200 text-gray-500 text-[9px] font-bold flex items-center justify-center flex-shrink-0 mt-0.5", children: i + 1 }),
...
function ConnectionBadge({ ok, label }) {
  if (ok === null || ok === void 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-medium text-slate-400 border border-slate-200 rounded px-1.5 py-0.5", children: [
      label,
      " —"
    ] });
  }
  return ok ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-semibold text-emerald-700 bg-emerald-50 border border-emerald-200 rounded px-1.5 py-0.5", children: [
    label,
    " ✓"
  ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-[10px] font-semibold text-red-700 bg-red-50 border border-red-200 rounded px-1.5 py-0.5", children: [
    label,
    " ✗"
  ] });
}
function DomainRow({ domain, isActive, onSelect, onEdit }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `w-full text-left px-3 py-2 rounded-lg border transition-all ${isActive ? "bg-amber-50 border-amber-200 text-amber-800" : "bg-white border-slate-200 text-slate-700 hover:bg-slate-50"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] font-semibold", children: domain.displayName || domain.hostname }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-slate-500", children: domain.hostname })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
            isActive && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-amber-500", title: "Active" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                onClick: (e) => {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mt-1 flex-wrap", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: domain.ga4Connected || null, label: "GA4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: domain.gtmConnected || null, label: "GTM" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: domain.bqConnected || null, label: "BQ" }),
          domain.agentContext?.businessType && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] font-medium text-amber-600 bg-amber-50 border border-amber-100 rounded px-1.5 py-0.5", children: domain.agentContext.businessType })
        ] })
      ]
    }
  );
...
function DomainEditor({ domain, onSave, onCancel, onUploadSA, onTestConnection, onRemoveSA, loading }) {
  ...
  const handleSave = () => {
    const agentContext = {
      ...
      keyEvents: form.agentKeyEvents ? form.agentKeyEvents.split(",").map((s) => s.trim()).filter(Boolean) : [],
      funnelStages: form.agentFunnelStages ? form.agentFunnelStages.split("\n").map((s) => s.trim()).filter(Boolean) : [],
  ...
  const inputClass = "w-full px-2.5 py-1.5 text-[12px] border border-slate-200 rounded-md bg-white text-slate-700 placeholder-slate-400 focus:outline-none focus:ring-1 focus:ring-amber-400 focus:border-amber-300";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-slate-50 border border-slate-200 rounded-xl p-4 space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[12px] font-bold text-slate-700", children: isNew ? "Add Domain Agent" : `Configure: ${domain.hostname}` }),
    isNew && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: "Hostname" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: "Display name (optional)" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: inputClass,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: [
        "GA4 Property ID ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: "(numeric, e.g. 123456789)" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: "GTM Container ID" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: inputClass,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-slate-200 pt-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[11px] font-bold text-slate-600", children: "Agent Context" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-[10px] text-slate-400 font-normal", children: "— helps data fairy personalise analysis and learn across clients" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: "Business type" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "select",
          {
            className: inputClass,
            ...
            children: BUSINESS_TYPES.map((bt) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: bt.value, children: bt.label }, bt.value))
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: [
          "Description ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: '(optional — e.g. "SaaS CRM, free trial → upgrade funnel")' })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: "(comma-separated GA4 event names)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: [
          "Funnel stages ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: "(one per line, in order)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "text-[11px] font-medium text-slate-500 block mb-0.5", children: [
          "Notes for data fairy ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-slate-400", children: "(migration history, known quirks, etc.)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "textarea",
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: isNew ? "Create Agent" : "Save Changes"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    !isNew && /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t border-slate-200 pt-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-[11px] font-bold text-slate-600 block mb-1.5", children: "Service Account JSON Key" }),
      domain.saKeyEmail ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-emerald-50 border border-emerald-200 rounded-lg px-3 py-2 mb-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-emerald-700", children: "Key uploaded" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-emerald-600 font-mono", children: domain.saKeyEmail })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 border border-amber-200 rounded-lg px-3 py-2 mb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-amber-700", children: "No key uploaded. Create a service account in the client's GCP project with read-only access to their GA4/GTM/BigQuery, then upload the JSON key here." }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "flex-1 cursor-pointer py-1.5 text-[12px] font-medium text-center text-slate-600 bg-white border border-slate-200 rounded-md hover:bg-slate-50 transition", children: [
          "📁 ",
        ...
        domain.ga4PropertyId || domain.gtmContainerId ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: handleTest,
            ...
            children: testLoading ? "Testing…" : "Test Connection"
          }
        ) : null
      ] }),
      testResult && !testResult.error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1.5 mt-2", children: [
        testResult.ga4 && /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: testResult.ga4.ok, label: "GA4" }),
        testResult.gtm && /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: testResult.gtm.ok, label: "GTM" }),
        testResult.bq && /* @__PURE__ */ jsxRuntimeExports.jsx(ConnectionBadge, { ok: testResult.bq.ok, label: "BQ" })
      ] }),
      testResult?.error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-red-600 mt-1", children: testResult.error })
    ] }) })
  ] });
}
function SettingsPanel({
  ...
  if (!user) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center py-12 px-6 text-center gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 rounded-full bg-amber-100 flex items-center justify-center text-2xl", children: "🔑" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[13px] font-semibold text-slate-700 mb-1", children: "Connect your Google account" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-slate-500", children: "Sign in to link GA4 properties, GTM containers, and BigQuery datasets to your domain agents." })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-red-600", children: error }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: onSignIn,
          ...
          children: loading ? "Connecting…" : "Sign in with Google"
        }
      )
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 pb-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-slate-50 border border-slate-200 rounded-xl px-3 py-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        user.picture ? /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: user.picture, alt: "", className: "w-6 h-6 rounded-full" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 rounded-full bg-amber-200 flex items-center justify-center text-[10px] font-bold text-amber-700", children: user.email?.[0]?.toUpperCase() }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] font-semibold text-slate-700", children: user.name || user.email }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-slate-500", children: user.email })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
    ...
    (localError || error) && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-red-50 border border-red-200 rounded-lg px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-red-700", children: localError || error }) }),
    editingDomain === null ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-[11px] font-bold text-slate-500 uppercase tracking-wider", children: "Domain Agents" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        domains.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-6 bg-slate-50 border border-dashed border-slate-200 rounded-xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[12px] text-slate-500 mb-3", children: "No domain agents yet" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: () => setEditingDomain(false),
        ...
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: domains.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          DomainRow,
          {
            domain: d,
      ...
      activeDomainId && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-amber-50 border border-amber-100 rounded-xl px-3 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-[11px] text-amber-700", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold", children: "Active agent:" }),
        " ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("details", { className: "bg-slate-50 border border-slate-200 rounded-xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("summary", { className: "px-3 py-2 text-[11px] font-semibold text-slate-600 cursor-pointer", children: "How to set up a service account" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 pb-3 space-y-1.5", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("ol", { className: "text-[11px] text-slate-600 space-y-1 list-decimal list-inside", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Open ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Google Cloud Console" }),
          " in the client's GCP project"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Go to ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "IAM & Admin → Service Accounts" }),
          " → Create"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Name it something like ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-slate-200 px-1 rounded", children: "fairy-reader" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "Grant roles: ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-slate-200 px-1 rounded", children: "Viewer" }),
          " on GA4, ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-slate-200 px-1 rounded", children: "Tag Manager Read-Only" }),
          " on GTM"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "For BigQuery: grant ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "bg-slate-200 px-1 rounded", children: "BigQuery Data Viewer" }),
          " on their analytics dataset"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Create a JSON key → download → upload here" })
      ] }) })
    ] })
  ] });
}
const INJECT_HOOK_CODE = () => {
  ...
  function safeClone(v, depth) {
    ...
    var t2 = typeof v;
    if (v == null || t2 === "string" || t2 === "number" || t2 === "boolean") return v;
    if (t2 === "function") return "[Function]";
    if (t2 === "symbol" || t2 === "bigint") return String(v);
    try {
      if (v instanceof Node) return "<" + (v.tagName || "node").toLowerCase() + ">";
    } catch (e) {
    }
    ...
    if (t2 === "object") {
      try {
        ...
        for (var i = 0; i < Math.min(keys.length, 100); i++) {
          try {
            out[keys[i]] = safeClone(v[keys[i]], depth + 1);
          } catch (e) {
            out[keys[i]] = "[Error]";
          }
        }
  ...
  function capture(item) {
    ...
    safe.time = (/* @__PURE__ */ new Date()).toISOString();
  ...
  function hookDL() {
    ...
    dl.push = function() {
      for (var i2 = 0; i2 < arguments.length; i2++) capture(arguments[i2]);
  ...
  setInterval(function() {
    if (window.dataLayer && !window.dataLayer.__fairyH) hookDL();
  }, 1e3);
  function hookGtag() {
  ...
  if (!hookGtag()) {
    ...
    var t = setInterval(function() {
      if (hookGtag() || Date.now() - start > 1e4) clearInterval(t);
    }, 100);
  }
};
...
function useFairyRecorder() {
  ...
  const injectHook = reactExports.useCallback(async (tabId) => {
  ...
  const parseGa4Hit = reactExports.useCallback((url) => {
    try {
      const u = new URL(url);
  ...
  const lintNewEvent = reactExports.useCallback((event, index) => {
  ...
  const pollEvents = reactExports.useCallback(async () => {
  ...
  const exportJSON = reactExports.useCallback(() => {
    const data = {
    ...
    a.href = url;
    a.download = `fairy-recording-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 19).replace(/:/g, "-")}.json`;
    a.click();
...
function useFairyCrawler(activeTabId, analyzeWithAgent = null) {
  const [crawling, setCrawling] = reactExports.useState(false);
  const [progress, setProgress] = reactExports.useState(null);
  const [crawlReport, setCrawlReport] = reactExports.useState(null);
  const [agentAnalysis, setAgentAnalysis] = reactExports.useState(null);
  const [errors, setErrors] = reactExports.useState([]);
  const portRef = reactExports.useRef(null);
  const analyzeWithAgentRef = reactExports.useRef(analyzeWithAgent);
  reactExports.useEffect(() => {
    analyzeWithAgentRef.current = analyzeWithAgent;
  }, [analyzeWithAgent]);
  const disconnectPort = reactExports.useCallback(() => {
    if (portRef.current) {
      try {
    ...
    port.onMessage.addListener((msg) => {
      switch (msg.type) {
        ...
        case "FAIRY_CRAWL_ERROR":
          setErrors((prev) => [
            ...prev,
            { url: msg.url, error: msg.error, time: (/* @__PURE__ */ new Date()).toISOString() }
          ]);
          break;
      }
    });
  ...
  const startCrawl = reactExports.useCallback((startUrl, maxPages = 50) => {
    setCrawling(true);
    setCrawlReport(null);
    setAgentAnalysis(null);
    setErrors([]);
  ...
  const stopCrawl = reactExports.useCallback(() => {
    try {
      portRef.current?.postMessage({ type: "FAIRY_CRAWL_STOP" });
    } catch (e) {
    }
  }, []);
  const clearReport = reactExports.useCallback(() => {
    setCrawlReport(null);
    setAgentAnalysis(null);
    setErrors([]);
    setProgress(null);
...
const API_BASE = define_process_env_default.VITE_FAIRY_API_URL || "https://fairy-api-PLACEHOLDER.run.app";
...
function useDomainAgent() {
  const [user, setUser] = reactExports.useState(null);
  const [domains, setDomains] = reactExports.useState([]);
  const [activeDomainId, setActiveDomainId] = reactExports.useState(null);
  ...
  const refreshDomains = reactExports.useCallback(async (token) => {
    try {
  ...
  const requireToken = reactExports.useCallback(async () => {
  ...
  const createDomain = reactExports.useCallback(async ({ hostname, displayName }) => {
  ...
  const updateDomainConfig = reactExports.useCallback(async (domainId, config) => {
    const token = await requireToken();
    setLoading(true);
    try {
  ...
  const deleteDomainAgent = reactExports.useCallback(async (domainId) => {
    const token = await requireToken();
  ...
  const uploadServiceAccount = reactExports.useCallback(async (domainId, serviceAccountJson) => {
    const token = await requireToken();
    setLoading(true);
    try {
  ...
  const removeServiceAccount = reactExports.useCallback(async (domainId) => {
    const token = await requireToken();
    await apiFetch(`/domains/${domainId}/service-account`, { method: "DELETE", token });
    await refreshDomains(token);
  }, [requireToken, refreshDomains]);
  const testConnection = reactExports.useCallback(async (domainId) => {
    const token = await requireToken();
    setLoading(true);
    try {
  ...
  const analyzeWithAgent = reactExports.useCallback(async (crawlReport, mode = "ga4") => {
  ...
  const handleSetActiveDomainId = reactExports.useCallback(async (id) => {
...
const THEMES = {
  ...
  "gtm-hygiene": {
    ...
    impactWeight: 3,
    ruleIds: [
      "gtm-event-naming-inconsistent",
      "gtm-no-custom-events",
      "gtm-rapid-duplicate-fire",
      "gtm-datalayer-push-no-event",
...
function calculateHealthScore(events, network, findings) {
  ...
  const eventsWithErrors = new Set(
    errorFindings.map((f) => f.eventIndex).filter((idx) => idx !== void 0)
  ).size;
...
function generateActionItems(themedGroups, maxItems = 15) {
  ...
  for (const group of themedGroups) {
    ...
    for (const f of uniqueFindings) {
      ...
      const uniqueCount = uniqueNames.size || 1;
      ...
      if (convLabel) {
        ...
        conversationalTitle = template.replace("{{n}}", String(uniqueCount)).replace("{{total}}", String(occurrences)).replace("{{s}}", occurrences === 1 ? "" : "s");
      }
      actions.push({
...
function deriveInsights(events, network, findings) {
  ...
  const measurementIds = configs.map((e) => e.measurementId).filter(Boolean);
  ...
  const allEventNames = events.map((e) => e.eventName || e.payload?.event).filter(Boolean);
  ...
  if (distinctNames.length > 0) {
    ...
    const detailParts = sorted.slice(0, 12).map(
  ...
  const ecomEvents = /* @__PURE__ */ new Set([
    "view_item",
    "add_to_cart",
    "begin_checkout",
    "purchase",
  ...
  const totalEvents = events.length + network.length;
  const errorFindings = findings.filter((f) => f.severity === "error");
  const eventsWithErrors = new Set(errorFindings.map((f) => f.eventIndex).filter((idx) => idx !== void 0));
  ...
  for (const page of pages) {
    ...
    for (const evt of page.events) {
      ...
      if (name && !name.startsWith("gtm.")) {
        if (!eventNamesByPage[name]) eventNamesByPage[name] = /* @__PURE__ */ new Set();
        eventNamesByPage[name].add(page.url);
      }
    }
  }
  const rareEvents = Object.entries(eventNamesByPage).filter(([, urls]) => urls.size === 1 && totalPages > 3);
...
function analyzeSession({ events = [], network = [], findings = [], crawlReport = null, mode = "ga4", ga4VersionOverride = "auto" }) {
  let ga4Version = null;
  if (typeof window !== "undefined" && window.FairyLint) {
  ...
  const modeFindings = mode === "gtm" ? findings.filter((f) => f.category === "gtm") : findings.filter((f) => f.category !== "gtm");
  const crawlAnalysis = crawlReport ? analyzeCrawl(crawlReport) : null;
  const hasRecorderData = events.length + network.length > 0;
  const crawlModeFindings = crawlAnalysis ? mode === "gtm" ? crawlAnalysis.allFindings.filter((f) => f.category === "gtm") : crawlAnalysis.allFindings.filter((f) => f.category !== "gtm") : [];
  const effectiveFindings = hasRecorderData ? modeFindings : crawlModeFindings;
  const effectiveTotalEvents = hasRecorderData ? events.length + network.length : crawlAnalysis?.totalEvents || 0;
  const health = hasRecorderData ? calculateHealthScore(events, network, modeFindings) : calculateHealthScore(Array.from({ length: effectiveTotalEvents }), [], effectiveFindings);
  ...
  return {
    ...
    summary: {
      ...
      eventsWithErrors: new Set(
        effectiveFindings.filter((f) => f.severity === "error").map((f) => f.eventIndex).filter((idx) => idx !== void 0)
      ).size,
...
function FairyLogo({ height = 18 }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("svg", { height, viewBox: "700 455 530 165", xmlns: "http://www.w3.org/2000/svg", style: { display: "block", width: "auto", flexShrink: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M742.89,589.99c-8.23,0-14.9-3.12-20-9.36-5.09-6.24-7.64-14.63-7.64-25.16s2.61-18.49,7.83-24.9c5.22-6.41,11.91-9.61,20.06-9.61s14.31,3.23,18.47,9.68h.38v-33.63h17.33v91.07h-16.69v-8.54h-.26c-4.25,6.97-10.74,10.44-19.49,10.44ZM746.71,575.47c5.1,0,8.98-1.74,11.66-5.22,2.68-3.48,4.01-8.28,4.01-14.39,0-13.92-5.05-20.89-15.16-20.89-4.67,0-8.24,1.87-10.7,5.6-2.46,3.74-3.69,8.71-3.69,14.91s1.21,11.3,3.63,14.77c2.42,3.48,5.84,5.22,10.25,5.22Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M851.92,532.53v-11.47h9.05v-18.7h16.94v18.7h11.21v11.47h-11.21v36.31c0,4.33,2.17,6.5,6.5,6.5l5.1-.13v12.74c-2.64.17-6.24.26-10.83.26-5.01,0-9.21-1.21-12.61-3.63-3.39-2.41-5.09-6.43-5.09-12.04v-40.01h-9.05Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M961.34,533.04v-11.97h8.92v-4.19c0-7.64,2.63-13.08,7.9-16.3s12.31-4.37,21.14-3.44v13.38c-4.33-.17-7.37.21-9.11,1.15-1.74.93-2.61,3.02-2.61,6.24v3.16h11.72v11.97h-11.72v55.04h-17.32v-55.04h-8.92Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#d97706", d: "M1033.3,521.06c-9,0-15.84,2.05-20.63,6.15-4.79,4.1-7.29,9.23-7.52,15.38h15.38c.57-6.15,4.79-9.12,12.65-9.12,3.53,0,6.27.68,8.09,2.05,1.94,1.37,2.85,3.3,2.85,5.7s-1.14,3.87-3.3,4.79c-2.17.8-6.38,1.71-12.53,2.62-8.32,1.14-14.7,3.3-19.26,6.38-4.67,3.08-6.95,7.98-6.95,14.59s2.05,11.28,6.27,14.81c4.1,3.42,9.69,5.24,16.52,5.24,5.24,0,9.23-.8,12.08-2.39,2.96-1.48,5.36-3.65,7.18-6.5l.11,7.29h16.52v-42.96c0-15.95-9.12-24.04-27.46-24.04ZM1044.46,565.05c0,3.42-1.37,6.27-4.1,8.77-2.74,2.51-6.5,3.65-11.28,3.65-6.72,0-10.14-2.73-10.14-8.2,0-2.96,1.03-5.01,3.08-6.5,1.94-1.37,5.47-2.62,10.37-3.76,6.27-1.37,10.26-2.73,12.08-3.76v9.8Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M926.98,521.06c-9,0-15.84,2.05-20.63,6.15-4.79,4.1-7.29,9.23-7.52,15.38h15.38c.57-6.15,4.79-9.12,12.65-9.12,3.53,0,6.27.68,8.09,2.05,1.94,1.37,2.85,3.3,2.85,5.7s-1.14,3.87-3.3,4.79c-2.17.8-6.38,1.71-12.53,2.62-8.32,1.14-14.7,3.3-19.26,6.38-4.67,3.08-6.95,7.98-6.95,14.59s2.05,11.28,6.27,14.81c4.1,3.42,9.69,5.24,16.52,5.24,5.24,0,9.23-.8,12.08-2.39,2.96-1.48,5.36-3.65,7.18-6.5l.11,7.29h16.52v-42.96c0-15.95-9.12-24.04-27.46-24.04ZM938.15,565.05c0,3.42-1.37,6.27-4.1,8.77-2.74,2.51-6.5,3.65-11.28,3.65-6.72,0-10.14-2.73-10.14-8.2,0-2.96,1.03-5.01,3.08-6.5,1.94-1.37,5.47-2.62,10.37-3.76,6.27-1.37,10.26-2.73,12.08-3.76v9.8Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#d97706", d: "M1071.77,589.66v-68.6h17.33v68.6h-17.33Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M1117.29,521.83v10.45h.38c2.04-3.82,4.28-6.64,6.75-8.47,2.46-1.83,5.56-2.74,9.3-2.74,1.79,0,3.14.17,4.08.51v15.16h-.38c-5.86-.6-10.57.68-14.14,3.82-3.57,3.14-5.35,8.07-5.35,14.77v34.34h-17.33v-67.84h16.69Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M1148.6,608.37v-13.63h6.11c6.45,0,9.68-2.97,9.68-8.91,0-2.89-1.55-9.35-4.86-18.26l-17.58-46.49h18.21l9.68,29.42,4.21,14.27h.25c1.19-5.51,2.46-10.27,3.82-14.27l9.17-29.42h17.45l-22.9,67.56c-2.55,7.47-5.41,12.62-8.6,15.47-3.19,2.84-8.01,4.27-14.46,4.27h-10.19Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#1c1917", d: "M818.84,521.06c-9,0-15.84,2.05-20.63,6.15-4.79,4.1-7.29,9.23-7.52,15.38h15.38c.57-6.15,4.79-9.12,12.65-9.12,3.53,0,6.27.68,8.09,2.05,1.94,1.37,2.85,3.3,2.85,5.7s-1.14,3.87-3.3,4.79c-2.17.8-6.38,1.71-12.53,2.62-8.32,1.14-14.7,3.3-19.26,6.38-4.67,3.08-6.95,7.98-6.95,14.59s2.05,11.28,6.27,14.81c4.1,3.42,9.69,5.24,16.52,5.24,5.24,0,9.23-.8,12.08-2.39,2.96-1.48,5.36-3.65,7.18-6.5l.11,7.29h16.52v-42.96c0-15.95-9.12-24.04-27.46-24.04ZM830.01,565.05c0,3.42-1.37,6.27-4.1,8.77-2.74,2.51-6.5,3.65-11.28,3.65-6.72,0-10.14-2.73-10.14-8.2,0-2.96,1.03-5.01,3.08-6.5,1.94-1.37,5.47-2.62,10.37-3.76,6.27-1.37,10.26-2.73,12.08-3.76v9.8Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#d97706", d: "M1080.8,481.41c-3.89,7.18-9.78,13.08-16.97,16.97,7.18,3.89,13.08,9.78,16.97,16.97,3.89-7.19,9.78-13.08,16.97-16.97-7.18-3.89-13.08-9.78-16.97-16.97ZM1080.79,508.8v.14s0-.09,0-.14c-.02-5.72-4.71-10.4-10.43-10.42-.05,0-.09,0-.14,0h.14c5.72-.02,10.41-4.7,10.43-10.42,0-.05,0-.09,0-.14v.14c.02,5.72,4.71,10.4,10.43,10.42h.14s-.09,0-.14,0c-5.72.02-10.41,4.7-10.43,10.42Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#d97706", d: "M1091.35,485.09v.09s0-.06,0-.09c-.01-3.67-3.02-6.67-6.69-6.68-.03,0-.06,0-.09,0h.09c3.67-.01,6.68-3.02,6.69-6.68,0-.03,0-.06,0-.09v.09c.01,3.67,3.02,6.67,6.69,6.68h.09s-.06,0-.09,0c-3.67.01-6.68,3.02-6.69,6.68Z" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("path", { fill: "#d97706", d: "M1061.71,509.57v.05s0-.03,0-.05c0-1.89-1.56-3.45-3.46-3.45-.02,0-.03,0-.05,0h.05c1.9,0,3.45-1.56,3.46-3.45,0-.02,0-.03,0-.05v.05c0,1.89,1.56,3.45,3.46,3.45h.05s-.03,0-.05,0c-1.9,0-3.45,1.56-3.46,3.45Z" })
  ] });
}
const GA4_TABS = [
...
function App() {
  ...
  const [mode, setMode] = reactExports.useState("ga4");
  const [activeTab, setActiveTab] = reactExports.useState("findings");
  const [agentReport, setAgentReport] = reactExports.useState(null);
  const [showAgentReport, setShowAgentReport] = reactExports.useState(false);
  const prevRecordingRef = reactExports.useRef(false);
  const prevCrawlingRef = reactExports.useRef(false);
  const tabs = mode === "ga4" ? GA4_TABS : GTM_TABS;
  reactExports.useEffect(() => {
    if (prevRecordingRef.current && !recording) {
      const hasData2 = events.length > 0 || network.length > 0 || findings.length > 0;
      if (hasData2) {
  ...
  const renderSettings = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    SettingsPanel,
    {
      user,
      domains,
  ...
  const modeFindings = reactExports.useMemo(() => {
  ...
  const groupedFindings = reactExports.useMemo(() => {
    const map = /* @__PURE__ */ new Map();
  ...
  const renderFindings = () => sortedFindings.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
    EmptyState,
    {
      title: recording ? "No issues found yet" : "Start recording to analyze events",
      subtitle: recording ? "Browse the site — data fairy will flag data quality issues in real time." : "Click Record, then browse the site. data fairy catches every dataLayer push and GA4 hit."
    }
  ) : groupedFindings.map(([ruleId, findings2]) => /* @__PURE__ */ jsxRuntimeExports.jsx(GroupedFindingCard, { ruleId, findings: findings2 }, ruleId));
  const renderEvents = () => events.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "No events captured yet", subtitle: "DataLayer pushes and gtag() calls will appear here." }) : groupedEvents.map(([name, entries]) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    GroupedEventRow,
    {
      eventName: name,
      events: entries,
  ...
  const renderNetwork = () => network.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(EmptyState, { title: "No network hits captured", subtitle: "GA4 /collect requests will appear here." }) : network.map((hit, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    EventRow,
    {
      event: hit,
      index: i + 1e3,
      findings: modeFindings.filter((f) => f.eventIndex === i + 1e3)
    },
    i
  ));
  const renderScanner = () => /* @__PURE__ */ jsxRuntimeExports.jsx(
    CrawlPanel,
    {
      crawling,
      progress,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4 min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(FairyLogo, { height: 18 }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Toolbar,
        {
          recording,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-1 mb-3 bg-slate-100 rounded-lg p-0.5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          onClick: () => handleModeChange("ga4"),
          className: `flex-1 px-3 py-1.5 text-[12px] font-semibold rounded-md transition ${mode === "ga4" ? "bg-white text-amber-600 shadow-sm" : "text-slate-400 hover:text-slate-600"}`,
          children: "GA4"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `flex-1 px-3 py-1.5 text-[12px] font-semibold rounded-md transition ${mode === "gtm" ? "bg-white text-amber-600 shadow-sm" : "text-slate-400 hover:text-slate-600"}`,
          children: "GTM"
        }
      )
    ] }),
    showAgentReport && agentReport && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      AgentReportPanel,
      {
        report: agentReport,
        agentAnalysis,
    ...
    hasData && !showAgentReport && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2 mb-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreCard, { label: "Events", value: stats.events, variant: "events" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        ScoreCard,
        {
          label: "w/ Errors",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreCard, { label: "Errors", value: stats.errors, variant: "errors" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ScoreCard, { label: "Warnings", value: stats.warnings, variant: "warnings" })
    ] }),
    hasData && !showAgentReport && !recording && !crawling && /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        onClick: runAnalysis,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("svg", { className: "w-3.5 h-3.5", fill: "none", viewBox: "0 0 24 24", stroke: "currentColor", strokeWidth: 2, children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", d: "M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z" }) }),
          "Analyze Session"
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Tabs, { tabs, activeTab, onTabChange: setActiveTab, counts: tabCounts }),
    activeTab === "settings" && renderSettings(),
    mode === "ga4" && activeTab !== "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      activeTab === "findings" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderFindings() }),
      activeTab === "events" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderEvents() }),
      activeTab === "network" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderNetwork() }),
      activeTab === "scanner" && renderScanner()
    ] }),
    mode === "gtm" && activeTab !== "settings" && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      activeTab === "gtm-findings" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderFindings() }),
      activeTab === "gtm-datalayer" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderEvents() }),
      activeTab === "gtm-network" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: renderNetwork() }),
...
//# sourceMappingURL=index-DuVOBlAf.js.map
